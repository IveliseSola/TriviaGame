$(document).ready(function () {
    ...
    function showTriviaQuestion() {
        ...
        $(".info").empty();
        $(".image").empty();
        $(".current-question").html(" <h4> Question # " + (currentQuestion + 1) + " / " + questions.length + "</h4>");
    ...
    function answerPage() {
        ...
        if ((playerChoice == rightAnswerIndex) && (answered == true)) {
            ...
            // $(".image").append('<img src="' + questions[currentQuestion].image + '" />');
        ...
        if (currentQuestion == (questions.length - 1)) {
            ...
            currentQuestion++;
            setTimeout(showTriviaQuestion, 7000);
        }
    }
